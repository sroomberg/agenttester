...
class TestBuildPrompt:
    def test_includes_branch(self) -> None:
        ...
        assert "`agenttester/claude/abc123`" in result

    def test_includes_run_name_and_agent_name(self) -> None:
        result = _build_prompt("test", "run123", "myagent", "")
        assert "agenttester/myagent/run123" in result
    ...
    def test_skills_prepended_before_branch(self) -> None:
        ...
        branch_pos = result.index("agenttester/claude/r1")
    ...
    def test_no_skills_still_includes_branch_and_prompt(self) -> None:
        ...
        assert "agenttester/agent1/r1" in result
